...
export const zonedDateTimeFns: IZonedDateTimeFns = {
  ...
  add: (zdt, durationLike, options) => toIsoZonedDateTime(Temporal.ZonedDateTime.from(zdt).add(durationLike, options)),
  ...
  isBefore: (zdt, other) => Temporal.ZonedDateTime.compare(zdt, other) < 0,
  isAfter: (zdt, other) => Temporal.ZonedDateTime.compare(zdt, other) > 0,
  isEqualOrBefore: (zdt, other) => Temporal.ZonedDateTime.compare(zdt, other) <= 0,
  isEqualOrAfter: (zdt, other) => Temporal.ZonedDateTime.compare(zdt, other) >= 0,
...
export function buildZonedDateTimeChainFromTemporal(zdt: Temporal.ZonedDateTime): IZonedDateTimeChain {
  return {
    ...
    isBefore: (other) => buildChain(Temporal.ZonedDateTime.compare(zdt, other) < 0),
    isAfter: (other) => buildChain(Temporal.ZonedDateTime.compare(zdt, other) > 0),
    isEqualOrBefore: (other) => buildChain(Temporal.ZonedDateTime.compare(zdt, other) <= 0),
    isEqualOrAfter: (other) => buildChain(Temporal.ZonedDateTime.compare(zdt, other) >= 0),
