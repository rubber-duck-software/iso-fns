...
describe('ZonedDateTime', () => {
  ...
  describe('string parsing', () => {
    ...
    it('variant time separators', () => {
      ;['1976-11-18t15:23-08:00[America/Los_Angeles]', '1976-11-18 15:23-08:00[America/Los_Angeles]'].forEach((input) =>
        assert.equal(`${zonedDateTimeFns.from(input)}`, '1976-11-18T15:23:00-08:00[America/Los_Angeles]')
      )
    })
    it('any number of decimal places', () => {
      ...
      assert.equal(
        `${zonedDateTimeFns.from('1976-11-18T15:23:30.1234-08:00[America/Los_Angeles]')}`,
        '1976-11-18T15:23:30.1234-08:00[America/Los_Angeles]'
      )
      assert.equal(
        `${zonedDateTimeFns.from('1976-11-18T15:23:30.12345-08:00[America/Los_Angeles]')}`,
        '1976-11-18T15:23:30.12345-08:00[America/Los_Angeles]'
      )
      assert.equal(
        `${zonedDateTimeFns.from('1976-11-18T15:23:30.123456-08:00[America/Los_Angeles]')}`,
        '1976-11-18T15:23:30.123456-08:00[America/Los_Angeles]'
      )
      assert.equal(
        `${zonedDateTimeFns.from('1976-11-18T15:23:30.1234567-08:00[America/Los_Angeles]')}`,
        '1976-11-18T15:23:30.1234567-08:00[America/Los_Angeles]'
      )
      assert.equal(
        `${zonedDateTimeFns.from('1976-11-18T15:23:30.12345678-08:00[America/Los_Angeles]')}`,
        '1976-11-18T15:23:30.12345678-08:00[America/Los_Angeles]'
      )
      assert.equal(
        `${zonedDateTimeFns.from('1976-11-18T15:23:30.123456789-08:00[America/Los_Angeles]')}`,
    ...
    it('optional parts', () => {
      ...
      assert.equal(`${zonedDateTimeFns.from('2020-01-01[Asia/Tokyo]')}`, '2020-01-01T00:00:00+09:00[Asia/Tokyo]')
    })
    it('no junk at end of string', () =>
      assert.throws(() => zonedDateTimeFns.from('1976-11-18T15:23:30.123456789-08:00[America/Los_Angeles]junk'), RangeError))
    ...
    describe('Disambiguation option', () => {
      it('plain datetime with multiple instants - Fall DST in Brazil', () => {
        ...
        assert.equal(`${zonedDateTimeFns.from(str)}`, '2019-02-16T23:45:00-02:00[America/Sao_Paulo]')
        assert.equal(
      ...
      it('plain datetime with multiple instants - Spring DST in Los Angeles', () => {
        ...
        assert.equal(`${zonedDateTimeFns.from(str)}`, '2020-03-08T03:30:00-07:00[America/Los_Angeles]')
        assert.equal(
          `${zonedDateTimeFns.from(str, { disambiguation: 'compatible' })}`,
      ...
      it('uses disambiguation if offset is ignored', () => {
        const str = '2020-03-08T02:30[America/Los_Angeles]'
        const offset = 'ignore'
        assert.equal(`${zonedDateTimeFns.from(str, { offset })}`, '2020-03-08T03:30:00-07:00[America/Los_Angeles]')
        assert.equal(
  ...
  describe('property bags', () => {
    ...
    describe('Overflow option', () => {
      ...
      it('constrain', () => {
        assert.equal(`${zonedDateTimeFns.from(bad)}`, '2019-01-31T00:00:00+01:00[Africa/Lagos]')
        assert.equal(`${zonedDateTimeFns.from(bad, { overflow: 'constrain' })}`, '2019-01-31T00:00:00+01:00[Africa/Lagos]')
      })
    ...
    describe('Offset option', () => {
      ...
      it("{ offset: 'prefer' } if offset matches time zone (first 1:30 when DST ends)", () => {
        ...
        assert.equal(`${zonedDateTimeFns.from(obj, { offset: 'prefer' })}`, '2020-11-01T01:30:00-07:00[America/Los_Angeles]')
      })
      it("{ offset: 'prefer' } if offset matches time zone (second 1:30 when DST ends)", () => {
        const obj = { ...date, hour: 1, minute: 30, offset: '-08:00' }
        assert.equal(`${zonedDateTimeFns.from(obj, { offset: 'prefer' })}`, '2020-11-01T01:30:00-08:00[America/Los_Angeles]')
      })
      it("{ offset: 'prefer' } if offset does not match time zone", () => {
        const obj = { ...date, hour: 4, offset: '-07:00' }
        assert.equal(`${zonedDateTimeFns.from(obj, { offset: 'prefer' })}`, '2020-11-01T04:00:00-08:00[America/Los_Angeles]')
      })
      it("{ offset: 'ignore' } uses time zone only", () => {
        const obj = { ...date, hour: 4, offset: '-12:00' }
        assert.equal(`${zonedDateTimeFns.from(obj, { offset: 'ignore' })}`, '2020-11-01T04:00:00-08:00[America/Los_Angeles]')
      })
      it("{ offset: 'use' } uses offset only", () => {
        const obj = { ...date, hour: 4, offset: '-07:00' }
        assert.equal(`${zonedDateTimeFns.from(obj, { offset: 'use' })}`, '2020-11-01T03:00:00-08:00[America/Los_Angeles]')
      })
      it('throw when bad offset', () => {
        ;['', 'PREFER', 'balance', 3, null].forEach((offset) => {
          assert.throws(
    ...
    describe('Disambiguation option', () => {
      it('plain datetime with multiple instants - Fall DST in Brazil', () => {
        ...
        assert.equal(`${zonedDateTimeFns.from(obj)}`, '2019-02-16T23:45:00-02:00[America/Sao_Paulo]')
        assert.equal(
      ...
      it('plain datetime with multiple instants - Spring DST in Los Angeles', () => {
        ...
        assert.equal(`${zonedDateTimeFns.from(obj)}`, '2020-03-08T03:30:00-07:00[America/Los_Angeles]')
        assert.equal(
          `${zonedDateTimeFns.from(obj, { disambiguation: 'compatible' })}`,
          '2020-03-08T03:30:00-07:00[America/Los_Angeles]'
        )
      ...
      it('uses disambiguation if offset is ignored', () => {
        ...
        const obj = { year: 2020, month: 3, day: 8, hour: 2, minute: 30, timeZone: cali }
        const offset = 'ignore'
        assert.equal(`${zonedDateTimeFns.from(obj, { offset })}`, '2020-03-08T03:30:00-07:00[America/Los_Angeles]')
        assert.equal(
  ...
  describe('ZonedDateTime.with()', () => {
    let zdt = zonedDateTimeFns.from(dateTimeFns.fromNumbers(1976, 11, 18, 15, 23, 30, 123))
    zdt = zonedDateTimeFns.withTimeZone(zdt, 'UTC')
    it('zonedDateTimeFns.with(zdt, { year: 2019 } works', () => {
      assert.equal(`${zonedDateTimeFns.with(zdt, { year: 2019 })}`, '2019-11-18T15:23:30.123456789+00:00[UTC]')
    })
    it('zonedDateTimeFns.with(zdt, { month: 5 } works', () => {
      assert.equal(`${zonedDateTimeFns.with(zdt, { month: 5 })}`, '1976-05-18T15:23:30.123456789+00:00[UTC]')
    })
    it('zonedDateTimeFns.with(zdt, { day: 5 } works', () => {
      assert.equal(`${zonedDateTimeFns.with(zdt, { day: 5 })}`, '1976-11-05T15:23:30.123456789+00:00[UTC]')
    })
    it('zonedDateTimeFns.with(zdt, { hour: 5 } works', () => {
      assert.equal(`${zonedDateTimeFns.with(zdt, { hour: 5 })}`, '1976-11-18T05:23:30.123456789+00:00[UTC]')
    })
    it('zonedDateTimeFns.with(zdt, { minute: 5 } works', () => {
      assert.equal(`${zonedDateTimeFns.with(zdt, { minute: 5 })}`, '1976-11-18T15:05:30.123456789+00:00[UTC]')
    })
    it('zonedDateTimeFns.with(zdt, { second: 5 } works', () => {
      assert.equal(`${zonedDateTimeFns.with(zdt, { second: 5 })}`, '1976-11-18T15:23:05.123456789+00:00[UTC]')
    })
    it('zonedDateTimeFns.with(zdt, { millisecond: 5 } works', () => {
      assert.equal(`${zonedDateTimeFns.with(zdt, { millisecond: 5 })}`, '1976-11-18T15:23:30.005456789+00:00[UTC]')
    })
    it('zonedDateTimeFns.with(zdt, { month: 5, second: 15 } works', () => {
      assert.equal(`${zonedDateTimeFns.with(zdt, { month: 5, second: 15 })}`, '1976-05-18T15:23:15.123456789+00:00[UTC]')
    })
    describe('Overflow', () => {
      it('constrain', () => {
        const overflow = 'constrain'
        assert.equal(
          `${zonedDateTimeFns.with(zdt, { month: 29 }, { overflow })}`,
          '1976-12-18T15:23:30.123456789+00:00[UTC]'
        )
        assert.equal(`${zonedDateTimeFns.with(zdt, { day: 31 }, { overflow })}`, '1976-11-30T15:23:30.123456789+00:00[UTC]')
        assert.equal(`${zonedDateTimeFns.with(zdt, { hour: 29 }, { overflow })}`, '1976-11-18T23:23:30.123456789+00:00[UTC]')
      })
      it('reject', () => {
    ...
    it('options may only be an object or undefined', () => {
      ...
      ;[{}, () => {}, undefined].forEach((options) =>
        assert.equal(`${zonedDateTimeFns.with(zdt, { day: 5 }, options)}`, '1976-11-05T15:23:30.123456789+00:00[UTC]')
      )
    })
    ...
    it('incorrectly-spelled properties are ignored', () => {
      //@ts-expect-error
      assert.equal(`${zonedDateTimeFns.with(zdt, { month: 12, days: 15 })}`, '1976-12-18T15:23:30.123456789+00:00[UTC]')
    })
  ...
  describe('.withPlainTime manipulation', () => {
    ...
    it('withPlainTime({ hour: 10 }) works', () => {
      assert.equal(`${zonedDateTimeFns.withTime(zdt, { hour: 10 })}`, '2015-12-07T10:00:00-08:00[America/Los_Angeles]')
    })
    it('withPlainTime(time) works', () => {
      const time = timeFns.from('11:22')
      assert.equal(`${zonedDateTimeFns.withTime(zdt, time)}`, '2015-12-07T11:22:00-08:00[America/Los_Angeles]')
    })
    it("withPlainTime('12:34') works", () => {
      assert.equal(`${zonedDateTimeFns.withTime(zdt, '12:34')}`, '2015-12-07T12:34:00-08:00[America/Los_Angeles]')
    })
    it('object must contain at least one correctly-spelled property', () => {
  ...
  describe('ZonedDateTime.withTimeZone()', () => {
    const instant = instantFns.from('2019-11-18T15:23:30.123456789-08:00[America/Los_Angeles]')
    const zdt = instantFns.toZonedDateTime(instant, 'UTC')
    it('zonedDateTime.withTimeZone(America/Los_Angeles) works', () => {
      assert.equal(`${zonedDateTimeFns.withTimeZone(zdt, tz)}`, '2019-11-18T15:23:30.123456789-08:00[America/Los_Angeles]')
    })
  })

  describe('Reversibility of differences', () => {
    const earlier = zonedDateTimeFns.from('1976-11-18T15:23:30.123456789-03:00[America/Santiago]')
  ...
  describe('ZonedDateTime.until()', () => {
    const zdt = zonedDateTimeFns.from('1976-11-18T15:23:30.123456789+01:00[Europe/Vienna]')
    ...
    const earlier = zonedDateTimeFns.from('2019-01-08T09:22:36.123456789+01:00[Europe/Vienna]')
  ...
  describe('ZonedDateTime.getISOFields()', () => {
    const zdt1 = zonedDateTimeFns.from('1976-11-18T15:23:30.123456789+08:00[Asia/Shanghai]')
  ...
  describe('zonedDateTimeFns.compare( )', () => {
    const zdt1 = zonedDateTimeFns.from('1976-11-18T15:23:30.123456789+01:00[Europe/Vienna]')
