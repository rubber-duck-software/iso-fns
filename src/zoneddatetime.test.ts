...
describe('ZonedDateTime', () => {
  ...
  describe('.withPlainTime manipulation', () => {
    ...
    it('object must contain at least one correctly-spelled property', () => {
      //@ts-expect-error
      assert.throws(() => zonedDateTimeFns.withTime(zdt, { minutes: 12 }), TypeError)
    })
    it('incorrectly-spelled properties are ignored', () => {
      assert.equal(
        //@ts-expect-error
        `${zonedDateTimeFns.withTime(zdt, { hour: 10, seconds: 55 })}`,
  ...
  describe('Reversibility of differences', () => {
    ...
    const later = zonedDateTimeFns.from('2019-10-29T10:46:38.272-03:00[America/Santiago]')
    ...
    units.forEach((largestUnit) => {
      ...
      // #88
      // it(`zonedDateTimeFns.subtract(${earlier}, durationFns.negated(${diff})) == ${later}`, () => {
      //   assert.equal(zonedDateTimeFns.subtract(earlier, durationFns.negated(diff)), later)
      // })
      // it(`zonedDateTimeFns.add(${later}, durationFns.negated(${diff})) == ${earlier}`, () => {
    ...
    // #88
    // largestUnit.forEach((largestUnit) => {
  ...
  describe('date/time maths: hours overflow', () => {
    it('subtract result', () => {
      const later = zonedDateTimeFns.from('2019-10-29T10:46:38.271-03:00[America/Santiago]')
      const earlier = zonedDateTimeFns.subtract(later, { hours: 12 })
      assert.equal(earlier, '2019-10-28T22:46:38.271-03:00[America/Santiago]')
    })
    it('add result', () => {
      const earlier = zonedDateTimeFns.from('2020-05-31T23:12:38.271-04:00[America/Santiago]')
      const later = zonedDateTimeFns.add(earlier, { hours: 2 })
      assert.equal(later, '2020-06-01T01:12:38.271-04:00[America/Santiago]')
    })
    it('symmetrical with regard to negative durations', () => {
      assert.equal(
        zonedDateTimeFns.add(zonedDateTimeFns.from('2019-10-29T10:46:38.271-03:00[America/Santiago]'), {
          hours: -12
        }),
        '2019-10-28T22:46:38.271-03:00[America/Santiago]'
      )
      assert.equal(
        zonedDateTimeFns.subtract(zonedDateTimeFns.from('2020-05-31T23:12:38.271-04:00[America/Santiago]'), {
          hours: -2
        }),
        '2020-06-01T01:12:38.271-04:00[America/Santiago]'
      )
    })
  })

  describe('ZonedDateTime.add()', () => {
    const zdt = zonedDateTimeFns.from('1969-12-25T12:23:45.678+00:00[UTC]')
    ...
    //     assert.equal(one, '1969-12-15T12:23:45.678+00:00[UTC]'))
    //   it(`(${zdt}).add({ hours: 240, milliseconds: 800 }) = ${two}`, () =>
    //     assert.equal(two, '1970-01-04T12:23:45.678+00:00[UTC]'))
    ...
    it('zonedDateTimeFns.add(zdt, durationObj)', () => {
      const later = zonedDateTimeFns.add(zdt, durationFns.from('PT240H'))
      assert.equal(later, '1970-01-04T12:23:45.678+00:00[UTC]')
    })
    const jan31 = zonedDateTimeFns.from('2020-01-31T15:00-08:00[America/Vancouver]')
    it('constrain when ambiguous result', () => {
      assert.equal(zonedDateTimeFns.add(jan31, { months: 1 }), '2020-02-29T15:00-08:00[America/Vancouver]')
      assert.equal(
        zonedDateTimeFns.add(jan31, { months: 1 }, { overflow: 'constrain' }),
        '2020-02-29T15:00-08:00[America/Vancouver]'
      )
    })
    it('symmetrical with regard to negative durations in the time part', () => {
      assert.equal(zonedDateTimeFns.add(jan31, { minutes: -30 }), '2020-01-31T14:30-08:00[America/Vancouver]')
    ...
    it('options may only be an object or undefined', () => {
      ...
      ;[{}, () => {}, undefined].forEach((options) =>
        assert.equal(zonedDateTimeFns.add(zdt, { years: 1 }, options), '1970-12-25T12:23:45.678+00:00[UTC]')
      )
    })
    it('object must contain at least one correctly-spelled property', () => {
    ...
    it('incorrectly-spelled properties are ignored', () => {
      //@ts-expect-error
      assert.equal(zonedDateTimeFns.add(zdt, { hour: 1, minutes: 1 }), '1969-12-25T12:24:45.678+00:00[UTC]')
    })
  })
  ...
  describe('ZonedDateTime.subtract()', () => {
    ...
    it('inst.subtract(durationObj)', () => {
      const earlier = zonedDateTimeFns.subtract(zdt, durationFns.from('PT240H'))
      assert.equal(earlier, '1969-12-15T12:23:45.678+00:00[UTC]')
    })
    const mar31 = zonedDateTimeFns.from('2020-03-31T15:00-07:00[America/Vancouver]')
    it('constrain when ambiguous result', () => {
      assert.equal(zonedDateTimeFns.subtract(mar31, { months: 1 }), '2020-02-29T15:00-08:00[America/Vancouver]')
      assert.equal(
    ...
    it('symmetrical with regard to negative durations in the time part', () => {
      assert.equal(zonedDateTimeFns.subtract(mar31, { minutes: -30 }), '2020-03-31T15:30-07:00[America/Vancouver]')
    ...
    it('options may only be an object or undefined', () => {
      ...
      ;[{}, () => {}, undefined].forEach((options) =>
        assert.equal(zonedDateTimeFns.subtract(zdt, { years: 1 }, options), '1968-12-25T12:23:45.678+00:00[UTC]')
      )
    })
    it('object must contain at least one correctly-spelled property', () => {
    ...
    it('incorrectly-spelled properties are ignored', () => {
      //@ts-expect-error
      assert.equal(zonedDateTimeFns.subtract(zdt, { hour: 1, minutes: 1 }), '1969-12-25T12:22:45.678+00:00[UTC]')
    })
  })
  ...
  describe('ZonedDateTime.until()', () => {
    ...
    it('defaults to returning hours', () => {
      ...
      assert.equal(zonedDateTimeFns.until(feb20, zonedDateTimeFns.from('2021-02-01T00:00+01:00[Europe/Vienna]')), 'PT8784H')
      assert.equal(zonedDateTimeFns.until(zonedDateTimeFns.from('2020-02-01T00:00+01:00[Europe/Vienna]'), feb21), 'PT8784H')
    })
    ...
    it('can return subseconds', () => {
      ...
      assert.equal(durationFns.getSeconds(msDiff), 672800)
      assert.equal(durationFns.getMilliseconds(msDiff), 0)
    })
    ...
    it('options may only be an object or undefined', () => {
      ...
      ;[{}, () => {}, undefined].forEach((options) => assert.equal(zonedDateTimeFns.until(feb20, feb21, options), 'PT8784H'))
    })
    const earlier = zonedDateTimeFns.from('2019-01-08T09:22:36.123+01:00[Europe/Vienna]')
    const later = zonedDateTimeFns.from('2021-09-07T14:39:40.987+02:00[Europe/Vienna]')
    ...
    it('assumes a different default for largestUnit if smallestUnit is larger than hours', () => {
      ...
      assert.equal(zonedDateTimeFns.until(earlier, later, { smallestUnit: 'months', roundingMode: 'halfExpand' }), 'P32M')
      assert.equal(zonedDateTimeFns.until(earlier, later, { smallestUnit: 'weeks', roundingMode: 'halfExpand' }), 'P139W')
      assert.equal(zonedDateTimeFns.until(earlier, later, { smallestUnit: 'days', roundingMode: 'halfExpand' }), 'P973D')
    })
  ...
  describe('ZonedDateTime.since()', () => {
    ...
    it('defaults to returning hours', () => {
      ...
      assert.equal(
        zonedDateTimeFns.since(zonedDateTimeFns.from('2021-02-01T00:00:00.001+01:00[Europe/Vienna]'), feb20),
        'PT8784H0.001S'
      )
      assert.equal(
        zonedDateTimeFns.since(feb21, zonedDateTimeFns.from('2020-02-01T00:00:00.001+01:00[Europe/Vienna]')),
        'PT8783H59M59.999S'
      )
    })
    it('can return lower or higher units', () => {
    ...
    it('can return subseconds', () => {
      const later = zonedDateTimeFns.add(feb20, { days: 1, milliseconds: 250 })
      const msDiff = zonedDateTimeFns.since(feb20, later, { largestUnit: 'milliseconds' })
      assert.equal(durationFns.getSeconds(msDiff), -672800)
      assert.equal(durationFns.getMilliseconds(msDiff), -0)
    })
    it('does not include higher units than necessary', () => {
    ...
    it('assumes a different default for largestUnit if smallestUnit is larger than days', () => {
      ...
      assert.equal(zonedDateTimeFns.since(later, earlier, { smallestUnit: 'months', roundingMode: 'halfExpand' }), 'P32M')
      assert.equal(zonedDateTimeFns.since(later, earlier, { smallestUnit: 'weeks', roundingMode: 'halfExpand' }), 'P139W')
    })
    it('throws on invalid roundingMode', () => {
      //@ts-expect-error
    ...
    it('accepts singular units', () => {
      assert.equal(
        `${zonedDateTimeFns.since(earlier, later, { largestUnit: 'year' })}`,
        `${zonedDateTimeFns.since(earlier, later, { largestUnit: 'years' })}`
      )
      assert.equal(
        `${zonedDateTimeFns.since(earlier, later, { smallestUnit: 'year' })}`,
        `${zonedDateTimeFns.since(earlier, later, { smallestUnit: 'years' })}`
      )
      assert.equal(
        `${zonedDateTimeFns.since(earlier, later, { largestUnit: 'month' })}`,
        `${zonedDateTimeFns.since(earlier, later, { largestUnit: 'months' })}`
      )
      assert.equal(
        `${zonedDateTimeFns.since(earlier, later, { smallestUnit: 'month' })}`,
        `${zonedDateTimeFns.since(earlier, later, { smallestUnit: 'months' })}`
      )
      assert.equal(
        `${zonedDateTimeFns.since(earlier, later, { largestUnit: 'day' })}`,
        `${zonedDateTimeFns.since(earlier, later, { largestUnit: 'days' })}`
      )
      assert.equal(
        `${zonedDateTimeFns.since(earlier, later, { smallestUnit: 'day' })}`,
        `${zonedDateTimeFns.since(earlier, later, { smallestUnit: 'days' })}`
      )
      assert.equal(
        `${zonedDateTimeFns.since(earlier, later, { largestUnit: 'hour' })}`,
        `${zonedDateTimeFns.since(earlier, later, { largestUnit: 'hours' })}`
      )
      assert.equal(
        `${zonedDateTimeFns.since(earlier, later, { smallestUnit: 'hour' })}`,
        `${zonedDateTimeFns.since(earlier, later, { smallestUnit: 'hours' })}`
      )
      assert.equal(
        `${zonedDateTimeFns.since(earlier, later, { largestUnit: 'minute' })}`,
        `${zonedDateTimeFns.since(earlier, later, { largestUnit: 'minutes' })}`
      )
      assert.equal(
        `${zonedDateTimeFns.since(earlier, later, { smallestUnit: 'minute' })}`,
        `${zonedDateTimeFns.since(earlier, later, { smallestUnit: 'minutes' })}`
      )
      assert.equal(
        `${zonedDateTimeFns.since(earlier, later, { largestUnit: 'second' })}`,
        `${zonedDateTimeFns.since(earlier, later, { largestUnit: 'seconds' })}`
      )
      assert.equal(
        `${zonedDateTimeFns.since(earlier, later, { smallestUnit: 'second' })}`,
        `${zonedDateTimeFns.since(earlier, later, { smallestUnit: 'seconds' })}`
      )
      assert.equal(
        `${zonedDateTimeFns.since(earlier, later, { largestUnit: 'millisecond' })}`,
        `${zonedDateTimeFns.since(earlier, later, { largestUnit: 'milliseconds' })}`
      )
      assert.equal(
        `${zonedDateTimeFns.since(earlier, later, { smallestUnit: 'millisecond' })}`,
        `${zonedDateTimeFns.since(earlier, later, { smallestUnit: 'milliseconds' })}`
      )
    })
    it('rounds relative to the receiver', () => {
      const dt1 = zonedDateTimeFns.from('2019-01-01T00:00+00:00[UTC]')
  ...
  describe('ZonedDateTime.round()', () => {
    ...
    const incrementOneNearest: [Exclude<TemporalSingularUnit, 'year' | 'month' | 'week'>, string][] = [
      ['day', '1976-11-19T00:00+01:00[Europe/Vienna]'],
      ['hour', '1976-11-18T15:00+01:00[Europe/Vienna]'],
      ['minute', '1976-11-18T15:24+01:00[Europe/Vienna]'],
    ...
    const incrementOneCeil: [Exclude<TemporalSingularUnit, 'year' | 'month' | 'week'>, string][] = [
      ['day', '1976-11-19T00:00+01:00[Europe/Vienna]'],
      ['hour', '1976-11-18T16:00+01:00[Europe/Vienna]'],
      ['minute', '1976-11-18T15:24+01:00[Europe/Vienna]'],
    ...
    const incrementOneFloor: [Exclude<TemporalSingularUnit, 'year' | 'month' | 'week'>, string][] = [
      ['day', '1976-11-18T00:00+01:00[Europe/Vienna]'],
      ['hour', '1976-11-18T15:00+01:00[Europe/Vienna]'],
      ['minute', '1976-11-18T15:23+01:00[Europe/Vienna]'],
      ['second', '1976-11-18T15:23:30+01:00[Europe/Vienna]'],
      ['millisecond', '1976-11-18T15:23:30.123+01:00[Europe/Vienna]']
    ]
    ...
    it('halfExpand is the default', () => {
      assert.equal(`${zonedDateTimeFns.round(zdt, { smallestUnit: 'minute' })}`, '1976-11-18T15:24+01:00[Europe/Vienna]')
    ...
    it('rounding down is towards the Big Bang, not towards the epoch', () => {
      ...
      assert.equal(zonedDateTimeFns.round(zdt2, { smallestUnit, roundingMode: 'ceil' }), '1969-12-15T12:00:01+00:00[UTC]')
      assert.equal(zonedDateTimeFns.round(zdt2, { smallestUnit, roundingMode: 'floor' }), '1969-12-15T12:00+00:00[UTC]')
      assert.equal(zonedDateTimeFns.round(zdt2, { smallestUnit, roundingMode: 'trunc' }), '1969-12-15T12:00+00:00[UTC]')
      assert.equal(
    ...
    it('rounding down is towards the Big Bang, not towards 1 BCE', () => {
      ...
      const smallestUnit = 'second'
      assert.equal(zonedDateTimeFns.round(zdt3, { smallestUnit, roundingMode: 'ceil' }), '-000099-12-15T12:00:01+00:00[UTC]')
      assert.equal(zonedDateTimeFns.round(zdt3, { smallestUnit, roundingMode: 'floor' }), '-000099-12-15T12:00+00:00[UTC]')
      assert.equal(zonedDateTimeFns.round(zdt3, { smallestUnit, roundingMode: 'trunc' }), '-000099-12-15T12:00+00:00[UTC]')
      assert.equal(
    ...
    it('rounds to an increment of hours', () => {
      assert.equal(
        ...
        '1976-11-18T16:00+01:00[Europe/Vienna]'
      )
    })
    it('rounds to an increment of minutes', () => {
      assert.equal(
        zonedDateTimeFns.round(zdt, { smallestUnit: 'minute', roundingIncrement: 15 }),
        '1976-11-18T15:30+01:00[Europe/Vienna]'
      )
    })
    it('rounds to an increment of seconds', () => {
      assert.equal(
    ...
    it('1 day is a valid increment', () => {
      assert.equal(
        ...
        '1976-11-19T00:00+01:00[Europe/Vienna]'
      )
    })
    it('valid hour increments divide into 24', () => {
    ...
    const bal = zonedDateTimeFns.from('1976-11-18T23:59:59.999+01:00[Europe/Vienna]')
    units = ['day', 'hour', 'minute', 'second']
    units.forEach((smallestUnit) => {
      it(`balances to next ${smallestUnit}`, () => {
        assert.equal(zonedDateTimeFns.round(bal, { smallestUnit }), '1976-11-19T00:00+01:00[Europe/Vienna]')
      })
    })
    ...
    it('rounds correctly to a 25-hour day', () => {
      ...
      assert.equal(
        ...
        '2020-11-01T00:00-07:00[America/Vancouver]'
      )
      ...
      assert.equal(
        ...
        '2020-11-02T00:00-08:00[America/Vancouver]'
      )
    })
    ...
    it('rounding up to a nonexistent wall-clock time', () => {
      ...
      const rounded = zonedDateTimeFns.round(almostSkipped, { smallestUnit: 'second', roundingMode: 'halfExpand' })
      assert.equal(`${rounded}`, '2018-11-04T01:00-02:00[America/Sao_Paulo]')
    })

    describe('ZonedDateTime.toInstant()', () => {
      it('recent date', () => {
        const zdt = zonedDateTimeFns.from('2019-10-29T10:46:38.271+01:00[Europe/Amsterdam]')
        assert.equal(`${zonedDateTimeFns.toInstant(zdt)}`, '2019-10-29T09:46:38.271Z')
      })
      it('year ≤ 99', () => {
        const zdt = zonedDateTimeFns.from('+000098-10-29T10:46:38.271+00:00[UTC]')
        assert.equal(zonedDateTimeFns.toInstant(zdt), '0098-10-29T10:46:38.271Z')
      })
      it('year < 1', () => {
        let zdt = zonedDateTimeFns.from('+000000-10-29T10:46:38.271+00:00[UTC]')
        assert.equal(zonedDateTimeFns.toInstant(zdt), '0000-10-29T10:46:38.271Z')
        zdt = zonedDateTimeFns.from('-001000-10-29T10:46:38.271+00:00[UTC]')
        assert.equal(zonedDateTimeFns.toInstant(zdt), '-001000-10-29T10:46:38.271Z')
      })
      // it('year 0 leap day', () => {
      //   const zdt = zonedDateTimeFns.from('0000-02-29T00:00-00:01:15[Europe/London]')
      //   assert.equal(zonedDateTimeFns.toInstant(zdt), '0000-02-29T00:01:15Z')
      // })
    })
    describe('ZonedDateTime.toPlainDate()', () => {
      it('works', () => {
        const zdt = instantFns.toZonedDateTime(instantFns.from('2019-10-29T09:46:38.271Z'), tz)
    ...
    describe('ZonedDateTime.toPlainTime()', () => {
      it('works', () => {
        const zdt = instantFns.toZonedDateTime(instantFns.from('2019-10-29T09:46:38.271Z'), tz)
        assert.equal(zonedDateTimeFns.toTime(zdt), '02:46:38.271')
      })
    })
  })
  ...
  describe('properties around DST', () => {
    ...
    it('hoursInDay works when day starts at 1:00 due to DST start at midnight', () => {
      const zdt = zonedDateTimeFns.from('2015-10-18T12:00-02:00[America/Sao_Paulo]')
  ...
  describe('zonedDateTimeFns.compare( )', () => {
    ...
    const zdt2 = zonedDateTimeFns.from('2019-10-29T10:46:38.271+01:00[Europe/Vienna]')
