...
//     })
//     it('symmetrical with regard to negative durations', () => {
//       equal(`${PlainDateTime.from('2019-10-29T10:46:38.271986102').add({ hours: -12 })}`, '2019-10-28T22:46:38.271986102')
//       equal(
...
//       )
//       ;[{}, () => {}, undefined].forEach((options) => equal(`${jan31.add({ years: 1 }, options)}`, '2021-01-31T15:00:00'))
//     })
//     it('object must contain at least one correctly-spelled property', () => {
...
//       equal(`${earlier.until(later, { smallestUnit: 'month' })}`, `${earlier.until(later, { smallestUnit: 'months' })}`)
...
//       equal(`${earlier.until(later, { largestUnit: 'minute' })}`, `${earlier.until(later, { largestUnit: 'minutes' })}`)
//       equal(`${earlier.until(later, { smallestUnit: 'minute' })}`, `${earlier.until(later, { smallestUnit: 'minutes' })}`)
//       equal(`${earlier.until(later, { largestUnit: 'second' })}`, `${earlier.until(later, { largestUnit: 'seconds' })}`)
//       equal(`${earlier.until(later, { smallestUnit: 'second' })}`, `${earlier.until(later, { smallestUnit: 'seconds' })}`)
//       equal(
...
//       equal(`${later.since(earlier, { smallestUnit: 'month' })}`, `${later.since(earlier, { smallestUnit: 'months' })}`)
...
//       equal(`${later.since(earlier, { largestUnit: 'minute' })}`, `${later.since(earlier, { largestUnit: 'minutes' })}`)
//       equal(`${later.since(earlier, { smallestUnit: 'minute' })}`, `${later.since(earlier, { smallestUnit: 'minutes' })}`)
//       equal(`${later.since(earlier, { largestUnit: 'second' })}`, `${later.since(earlier, { largestUnit: 'seconds' })}`)
//       equal(`${later.since(earlier, { smallestUnit: 'second' })}`, `${later.since(earlier, { smallestUnit: 'seconds' })}`)
//       equal(
...
//       it(`rounds down to ${smallestUnit}`, () => equal(`${dt.round({ smallestUnit, roundingMode: 'floor' })}`, expected))
...
//         ;[new PlainDateTime(1976, 11, 18, 15, 23), { year: 2019, month: 1, day: 1 }, '2019-01-31T00:00'].forEach((input) => {
//           ;['', 'CONSTRAIN', 'balance', 3, null].forEach((overflow) =>
...
//     })
//     it('no junk at end of string', () => throws(() => PlainDateTime.from('1976-11-18T15:23:30.123456789junk'), RangeError))
...
//         })
//       })
//       equal(`${PlainDateTime.from({ year: -271821, month: 4, day: 19, nanosecond: 1 })}`, '-271821-04-19T00:00:00.000000001')
//       equal(
//         `${PlainDateTime.from({
//           year: 275760,
//           month: 9,
...
//     })
//     it('options may only be an object or undefined', () => {
//       ;[null, 1, 'hello', true, Symbol('foo'), 1n].forEach((badOptions) => throws(() => dt1.toString(badOptions), TypeError))
