...
describe('durationFns', () => {
  ...
  //     assert.equal(`${durationFns.with(duration, { years: 1 })}`, 'P1Y5M5W5DT5H5M5.005005005S')
  //   })
  //   it('duration.with({ months: 1 } works', () => {
  //     assert.equal(`${durationFns.with(duration, { months: 1 })}`, 'P5Y1M5W5DT5H5M5.005005005S')
  //   })
  //   it('duration.with({ weeks: 1 } works', () => {
  //     assert.equal(`${durationFns.with(duration, { weeks: 1 })}`, 'P5Y5M1W5DT5H5M5.005005005S')
  //   })
  //   it('duration.with({ days: 1 } works', () => {
  //     assert.equal(`${durationFns.with(duration, { days: 1 })}`, 'P5Y5M5W1DT5H5M5.005005005S')
  //   })
  //   it('duration.with({ hours: 1 } works', () => {
  //     assert.equal(`${durationFns.with(duration, { hours: 1 })}`, 'P5Y5M5W5DT1H5M5.005005005S')
  //   })
  //   it('duration.with({ minutes: 1 } works', () => {
  //     assert.equal(`${durationFns.with(duration, { minutes: 1 })}`, 'P5Y5M5W5DT5H1M5.005005005S')
  //   })
  //   it('duration.with({ seconds: 1 } works', () => {
  //     assert.equal(`${durationFns.with(duration, { seconds: 1 })}`, 'P5Y5M5W5DT5H5M1.005005005S')
  //   })
  //   it('duration.with({ milliseconds: 1 } works', () => {
  //     assert.equal(`${durationFns.with(duration, { milliseconds: 1 })}`, 'P5Y5M5W5DT5H5M5.001005005S')
  //   })
  //   it('duration.with({ months: 1, seconds: 15 } works', () => {
  //     assert.equal(`${durationFns.with(duration, { months: 1, seconds: 15 })}`, 'P5Y1M5W5DT5H5M15.005005005S')
  //   })
  //   it('mixed positive and negative values throw', () => {
  ...
  //   it('incorrectly-spelled properties are ignored', () => {
  //     //@ts-expect-error
  //     assert.equal(`${durationFns.with(duration, { month: 1, days: 1 })}`, 'P5Y5M5W1DT5H5M5.005005005S')
  //   })
  // })
  ...
  //     const d = durationFns.from('P50DT50H50M50.500500500S')
  ...
  //     assert.equal(durationFns.getMilliseconds(result), 1)
  //   })
  ...
  //     assert.equal(durationFns.getMilliseconds(result), 501)
  //   })
  ...
  //     result = durationFns.subtract(tenDays, { minutes: 15 })
  ...
  //     const d2 = durationFns.from({ hours: 1, seconds: 3721 })
  //     assert.equal(`${durationFns.subtract(d2, { minutes: 61 })}`, '-PT1M1.000000001S')
  //   })
  //   it('mixed positive and negative values always throw', () => {
  ...
  //   const d1 = durationFns.from('P3DT1H')
  //   const d1again = durationFns.from('P3DT1H')
  //   const d2 = durationFns.from('PT2H20M30S')
  //   it('=== is object equality', () => assert.equal(d1, d1))
  //   it('!== is object equality', () => assert.notEqual(d1, d1again))
  //   it('<', () => assert.throws(() => d1 < d2))
  //   it('>', () => assert.throws(() => d1 > d2))
  //   it('<=', () => assert.throws(() => d1 <= d2))
  //   it('>=', () => assert.throws(() => d1 >= d2))
  // })
  ...
  //   //     assert(durationFns.round(d, options) instanceof Iso)
  //   //   })
  //   // })
  ...
  //   //       const options = { smallestUnit, roundingIncrement, relativeTo }
  //   //       assert(durationFns.round(d, options) instanceof Temporal.Duration)
  //   //     })
  //   //   })
  //   // })
